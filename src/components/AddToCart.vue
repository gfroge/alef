<template>
    <div class="add-to-cart">
        <span class="add-to-cart__counter">
            <button @click="count++">+</button>
            {{ count }}
            <button @click="(count>1)?count--:count=1">-</button>
        </span>
        <button @click="showSnack(`Товар ${props.productName.toLowerCase()} в количестве ${count} единиц добавлен в корзину`);" class="add-to-cart__btn">
            Добавить в корзину
        </button>
        <button @click="showSnack(`Товар ${props.productName.toLowerCase()} в количестве ${count} единиц добавлен в избранное`);" class="add-to-cart__fav">
    ...
    <a href="" class="add-to-cart__link">Купить в 1 клик</a>
</template>
